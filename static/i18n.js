...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    onboarding_notice_gateway: 'Add messaging platforms (optional). You can also do this later in Settings.',
    onboarding_step_gateway_title: 'Messaging platforms',
    onboarding_step_gateway_desc: 'Connect to Feishu, DingTalk, WeChat, WeCom, QQ',
    onboarding_gateway_help: 'Configure IM platforms so Hermes can notify you on chat apps.',
    onboarding_gateway_label: 'Messaging',
    onboarding_gateway_configured: 'Configured',
    onboarding_gateway_not_configured: 'Not configured',
    onboarding_gateway_configure: 'Configure',
    onboarding_gateway_done: 'Done',
    onboarding_gateway_enable: 'Enable this channel',
    onboarding_gateway_cancel: 'Cancel',
    onboarding_gateway_save: 'Save',
    onboarding_gateway_saving: 'Saving...',
    onboarding_gateway_network_error: 'Network error',
    ...
    // Gateway Channels
    settings_tab_gateway: 'Gateway Channels',
    gateway_btn_start: 'Start',
    gateway_btn_stop: 'Stop',
    gateway_btn_restart: 'Restart',
    gateway_status_running: 'Backend service running',
    gateway_status_stopped: 'Stopped',
    gateway_status_unknown: 'Unknown',
    gateway_status_not_configured: 'Not configured',
    gateway_restart_note: 'IM configuration changes require backend restart to take effect',
    gateway_operation_failed: 'Operation failed',
    gateway_network_error: 'Network error',
    gateway_platforms: 'Platforms',
    gateway_enable_channel: 'Enable this channel',
    gateway_configured: 'Configured',
    gateway_not_configured: 'Not configured',
    gateway_test_connection: 'Test',
    gateway_reconfigure: 'Reconfigure',
    gateway_clear_config: 'Clear',
    gateway_scan_qr: 'Scan QR',
    gateway_manual_config: 'Manual',
    gateway_cancel: 'Cancel',
    gateway_save: 'Save',
    gateway_close: 'Close',
    gateway_scan_qr_title: 'Scan QR Code',
    gateway_loading_qr: 'Loading QR...',
    gateway_waiting_scan: 'Waiting for scan...',
    gateway_scan_confirmed: 'Scan confirmed!',
    gateway_qr_expired: 'QR code expired. Please try again.',
    gateway_enter_credentials: 'Enter credentials for {platform}',
    gateway_clear_confirm: 'Clear configuration for {platform}?',
    gateway_load_failed: 'Failed to load channels',

    // Custom Providers
    custom_providers_title: 'Custom Providers',
    custom_providers_desc: 'Add self-hosted or third-party OpenAI-compatible endpoints.',
    custom_provider_add: 'Add Custom Provider',
    custom_provider_edit: 'Edit Provider',
    custom_provider_name: 'Provider Name',
    custom_provider_base_url: 'Base URL',
    custom_provider_api_key: 'API Key',
    custom_provider_model: 'Model',
    custom_provider_cancel: 'Cancel',
    custom_provider_save: 'Save Changes',
    custom_provider_add_btn: 'Add Provider',
    custom_provider_no_providers: 'No custom providers configured.',
    custom_provider_loading: 'Loading...',
    custom_provider_fetching_models: 'Fetching models...',
    custom_provider_models_found: '{count} models found',
    custom_provider_no_models: 'No models found. You can type a model name manually.',
    custom_provider_fetch_failed: 'Failed to fetch models. You can type manually.',
    custom_provider_failed_to_load: 'Failed to load custom providers',
    custom_provider_failed_to_save: 'Failed to save',
    custom_provider_failed_to_delete: 'Failed to delete',
    custom_provider_delete_confirm: 'Delete provider "{name}"?',
  },
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    onboarding_notice_gateway: '添加消息平台（可选）。你也可以稍后在设置中配置。',
    onboarding_step_gateway_title: '消息平台',
    onboarding_step_gateway_desc: '连接飞书、钉钉、微信、企业微信、QQ',
    onboarding_gateway_help: '配置 IM 平台，Hermes 可以通过聊天应用通知你。',
    onboarding_gateway_label: '消息平台',
    onboarding_gateway_configured: '已配置',
    onboarding_gateway_not_configured: '未配置',
    onboarding_gateway_configure: '配置',
    onboarding_gateway_done: '已完成',
    onboarding_gateway_enable: '启用此渠道',
    onboarding_gateway_cancel: '取消',
    onboarding_gateway_save: '保存',
    onboarding_gateway_saving: '保存中…',
    onboarding_gateway_network_error: '网络错误',
    ...
    // Gateway Channels (IM配置)
    settings_tab_gateway: 'IM配置',
    gateway_btn_start: '启动',
    gateway_btn_stop: '停止',
    gateway_btn_restart: '重启',
    gateway_status_running: '后端服务运行中',
    gateway_status_stopped: '已停止',
    gateway_status_unknown: '未知',
    gateway_status_not_configured: '未配置',
    gateway_restart_note: '更改 IM 配置需要重启后端服务才能生效',
    gateway_operation_failed: '操作失败',
    gateway_network_error: '网络错误',
    gateway_platforms: '平台',
    gateway_enable_channel: '启用此频道',
    gateway_configured: '已配置',
    gateway_not_configured: '未配置',
    gateway_test_connection: '测试连接',
    gateway_reconfigure: '重新配置',
    gateway_clear_config: '清除配置',
    gateway_scan_qr: '扫码配置',
    gateway_manual_config: '手动输入',
    gateway_cancel: '取消',
    gateway_save: '保存',
    gateway_close: '关闭',
    gateway_scan_qr_title: '扫描二维码',
    gateway_loading_qr: '加载二维码...',
    gateway_waiting_scan: '等待扫描...',
    gateway_scan_confirmed: '扫描已确认!',
    gateway_qr_expired: '二维码已过期，请重试。',
    gateway_enter_credentials: '输入 {platform} 的凭证',
    gateway_clear_confirm: '清除 {platform} 的配置?',
    gateway_load_failed: '加载频道失败',

    // Custom Providers
    custom_providers_title: '自定义提供商',
    custom_providers_desc: '添加自托管或第三方 OpenAI 兼容端点。',
    custom_provider_add: '添加自定义提供商',
    custom_provider_edit: '编辑提供商',
    custom_provider_name: '提供商名称',
    custom_provider_base_url: '基础 URL',
    custom_provider_api_key: 'API 密钥',
    custom_provider_model: '模型',
    custom_provider_cancel: '取消',
    custom_provider_save: '保存更改',
    custom_provider_add_btn: '添加提供商',
    custom_provider_no_providers: '未配置自定义提供商。',
    custom_provider_loading: '加载中...',
    custom_provider_fetching_models: '正在获取模型...',
    custom_provider_models_found: '找到 {count} 个模型',
    custom_provider_no_models: '未找到模型。您可以手动输入模型名称。',
    custom_provider_fetch_failed: '获取模型失败。您可以手动输入。',
    custom_provider_failed_to_load: '加载自定义提供商失败',
    custom_provider_failed_to_save: '保存失败',
    custom_provider_failed_to_delete: '删除失败',
    custom_provider_delete_confirm: '删除提供商 "{name}"?',
  },
