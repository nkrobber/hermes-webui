...
function switchSettingsSection(name,opts){
  ...
  const map={conversation:'Conversation',appearance:'Appearance',preferences:'Preferences',providers:'Providers',gateway:'Gateway',plugins:'Plugins',extensions:'Extensions',system:'System',help:'Help'};
  // Sidebar menu items
  document.querySelectorAll('#settingsMenu .side-menu-item').forEach(it=>{
    it.classList.toggle('active', it.dataset.settingsSection===section);
  });
  // Panes in main
  ['conversation','appearance','preferences','providers','gateway','plugins','extensions','system','help'].forEach(key=>{
  ...
  if(!(opts&&opts.skipLazyLoad)){
    ...
    if(section==='gateway' && typeof loadGatewayPanel==='function') loadGatewayPanel();
...
async function loadProvidersPanel(){
  ...
  try{
    ...
    if(typeof renderCustomProvidersSection==='function'){
